...
def _calc_threshold_row(ticker: str, ma_rule: str, window: int, inputs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    display = f"{threshold_final:.2f}+" if threshold_final is not None else None
